...
public class GameMatch {
    ...
    public GameMatch(int id, int playerID1, int playerID2, int winnerID, int playTime, int totalMove,
            LocalDateTime startedTime, String chat) {
        this.id = id;
    ...
    public GameMatch(int playerID1, int playerID2, int winnerID, int playTime, int totalMove,
            LocalDateTime startedTime) {
        this.playerID1 = playerID1;
        this.playerID2 = playerID2;
        this.winnerID = winnerID;
