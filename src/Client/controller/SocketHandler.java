...
public class SocketHandler {
    ...
    private void listen() {
        ...
        // cảnh báo nếu kết nối bị gián đoạn
    ...
    private void onReceiveSignup(String received) {
        ...
        if (status.equals("failed")) {
            ...
            JOptionPane.showMessageDialog(RunClient.signupScene, "Đăng ký thành công", "Thành công",
    ...
    private void onReceiveListRoom(String received) {
        ...
        if (status.equals("failed")) {
            ...
            // i = 3; i < roomCount + 3: dữ liệu phòng bắt đầu từ index 3 trong mảng
            // splitted
    ...
    private void onReceiveResultPairMatch(String received) {
        ...
        if (status.equals("failed")) {
            String failedMsg = splitted[2];
            JOptionPane.showMessageDialog(RunClient.mainMenuScene, failedMsg, "Không thể ghép trận",
    ...
    private void onReceiveDataRoom(String received) {
        ...
        if (status.equals("failed")) {
            String failedMsg = splitted[2];
            JOptionPane.showMessageDialog(RunClient.mainMenuScene, failedMsg, "Không lấy được dữ liệu phòng",
                    JOptionPane.ERROR_MESSAGE);
    ...
    private void onReceiveLeaveRoom(String received) {
        ...
        if (status.equals("failed")) {
            String failedMsg = splitted[2];
            JOptionPane.showMessageDialog(RunClient.inGameScene, failedMsg, "Không thể thoát phòng",
                    JOptionPane.ERROR_MESSAGE);
    ...
    private void onReceivedEditProfile(String received) {
        ...
        if (status.equals("failed")) {
            ...
            JOptionPane.showMessageDialog(RunClient.profileScene, "Đổi thông tin thành công", "Thành công",
                    JOptionPane.INFORMATION_MESSAGE);
    ...
    private void onReceiveChangePassword(String received) {
        ...
        if (status.equals("failed")) {
            ...
            JOptionPane.showMessageDialog(RunClient.changePasswordScene, "Đổi mật khẩu thành công", "Thành công",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    }
